"""
Django settings for cbdash_pr_5850_1 project.
...
ROOT_URLCONF = 'cbdash_pr_5850_1.urls'
...
WSGI_APPLICATION = 'cbdash_pr_5850_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "cbdash-pr-5850 Support <support@cbdash-pr-5850-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cbdash_pr_5850_1 API",
    "DESCRIPTION": "API documentation for cbdash_pr_5850_1 App",
    "VERSION": "v1",
}
